    ...
    public static class ModelBuilderExtensions
    {
        public static void SeedData(this ModelBuilder builder)
        {
            builder.Entity<Category>().HasData(new[]
           {
                ...
                new Category() { Id = (int)Categories.Home_Garden, Name = "Home & Garden"},
                new Category() { Id = (int)Categories.Transport, Name = "Transport"},
                new Category() { Id = (int)Categories.Toys_Hobbies, Name = "Toys & Hobbies"},
                new Category() { Id = (int)Categories.Musical_Instruments, Name = "Musical Instruments"},
            ...
            builder.Entity<Product>().HasData(new[]
           {
                ...
                new Product() { Id = 2, Name = "PowerBall", CategoryId = (int)Categories.Toys_Hobbies, Price = 45.5M, ImageUrl = "https://http2.mlstatic.com/D_NQ_NP_727192-CBT53879999753_022023-V.jpg" },
                ...
                new Product() { Id = 5, Name = "Air Ball", CategoryId = (int)Categories.Sport, Price = 50, ImageUrl = "https://cdn.shopify.com/s/files/1/0046/1163/7320/products/69ee701e-e806-4c4d-b804-d53dc1f0e11a_grande.jpg" },
